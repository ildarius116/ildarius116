...
**Python-разработчик:**
Стаж - 3 года разработки.

### Мои проекты на ГитХабе:

#### Хакатон от МТС "МТС True Tech Hack 2026", задача "GPTHub: Единое окно для всех задач искусственного интеллекта (ИИ)".
- Суть: универсальное веб-приложение на базе OpenWebUI, которое объединяет текст, голос, изображения и работу с файлами в одном чате, автоматически выбирая нужную модель под задачу и используя долгосрочную память.
- **AI** проект: **_Полностью сгенерирован ИИ "Claude Code"_**
- Ссылка: https://github.com/ildarius116/GPT_Hub 
